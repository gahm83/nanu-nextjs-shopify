...
export function VersatileCompanion() {
  ...
  return (
    <div className="before:bg-[auto 6px] after:bg-[auto 5px] relative mx-auto flex w-full flex-col bg-[#532826] py-32 before:absolute before:left-6 before:right-6 before:top-10 before:block before:h-[6px] before:bg-border-sky before:bg-repeat-space before:content-[''] after:absolute after:bottom-10 after:left-6 after:right-6 after:block after:h-[5px] after:bg-border-sky after:bg-repeat-space after:content-['']">
