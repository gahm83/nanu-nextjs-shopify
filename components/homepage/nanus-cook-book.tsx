      ...
      <div className="relative py-16">
        <div className="mx-auto w-11/12 max-w-screen-lg">
          ...
          {recipes && recipes.length > 0 ? (
            ...
            <div className="relative pt-16 text-center font-plam-canyon-drive text-7xl font-normal">
              <span className="text-[#8DC8E8]">* </span>
              <h2 className="inline text-[#532826]">
                Oops! Looks like we're out of recipes. Check back soon for some tasty inspiration!!
              </h2>
              <span className="text-[#8DC8E8]"> *</span>
            </div>
          )}
